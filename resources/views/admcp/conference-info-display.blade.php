            ...
            <div class="gx-wrapper">
                ...
                <div class="animated slideInUpTiny animation-duration-3">
                    ...
                    <div class="page-heading d-sm-flex justify-content-sm-between align-items-sm-center">
                        <h2 class="title mb-3 mb-sm-0">Conference Paper/Abstracts</h2>
                        <nav class="breadcrumb">
                            <a href="/admin" class="breadcrumb-item">Dashboard</a>
                        
                            <span class="active breadcrumb-item">Paper/Abstracts</span>
                        </nav>
                    </div>
                    ...
                    <div class="row mb-md-12">
                        <div class="col-md-12 col-12">
                            <div class="shadow border-0 card">
                                ...
                                <div class="card-body">
                                    <h4 class="mb-4"><b>Name:</b> {{ $conference->name }}</h4>
                                    <h4 class="mb-4"><b>University Afiliation:</b> {{ $conference->university }}</h4>
                                    <h2 class="mb-4"><b>Title:</b> {{$conference->title}}</h2> 
                                    
                                       <h6 class="card-subtitle mb-4"><i>Author(s): {{ $conference->author }}</i></h6>

                                    <h2 class="mb-4"><b>Abstracts</b></h6>

                                    <p class="card-text"><i> {!! $conference->abstract !!} </i></p>
                                 
                                  <h2 class="mb-4"><b>Keywords: </b></h2>
                                  <p>{{ $conference->keywords }}</p>

                                    <a href="/documentconf/{{ $conference->filename}}" class="gx-btn gx-btn-sm gx-btn-primary" download>Download Paper/Abstract </a>
