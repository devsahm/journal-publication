            ...
            <div class="gx-wrapper">
                <div class="animated slideInUpTiny animation-duration-3">
                    <div class="page-heading d-sm-flex justify-content-sm-between align-items-sm-center">
                        <h2 class="title mb-3 mb-sm-0">Uploaded News Lists</h2>
                        <nav class="mb-0 breadcrumb">
                            <a href="/admin" class="breadcrumb-item">Dashboard</a>
                            
                            <span class="active breadcrumb-item">News</span>
                        </nav>
                    </div>
                                    ...
                                    @include('success')
                                        <table class="table table-users default-table table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <th><a href="/blog/{{ $blog->id }}" class="btn btn-info" style="margin-left: 20px" ><i class="fa fa-eye"></i>View News</a></th>
                                           
                                                <td>
                                                
                                                   <a href="/blog/{{ $blog->id }}/edit" class="btn btn-primary"><i class="fa fa-edit"></i>Edit News Blog</a>
                                                </td>
                                                ...
                                                <form method="post" action="/blog/{{ $blog->id }}">
                                                 @method('DELETE')
                                                 @csrf
                                                <button type="Submit" class="btn btn-danger"  onclick="return confirm('Are you sure to delete?')"><i class="fa fa-trash"></i>Delete News</button>
                                                </form>
                                                </td>
                                                 <?php $counter++; ?>
                                               ...
                                               @else
                                                ...
                                                <p style="margin:auto;">No blog record was found</p>
