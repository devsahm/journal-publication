        ...
        <div class="gx-main-content">
            ...
            <div class="gx-wrapper">
                <div class="page-heading d-sm-flex justify-content-sm-between align-items-sm-center">
                    <h2 class="title mb-3 mb-sm-0"> News Blog</h2>
                    <nav class="mb-0 breadcrumb">
                        <a href="/admin" class="breadcrumb-item">Dashboard</a>
                     
                        <span class="active breadcrumb-item">Blog</span>
                    </nav>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-8 col-md-7 col-sm-6 col-12">
                        <div class="card shadow border-0 text-muted">
                            @if($blog->image==null)
                            <div class="alert alert-info">No image was uploaded for this blog post</div>
                            @else
                            <img class="card-img-top" src="/blogimages/{{ $blog->image}}" alt="post">
                            @endif
                            <div class="card-body">
                                <h3>{{$blog->title}} </h3>
                                <div class="meta-wrapper">
                                    <span class="meta-date"><i class="zmdi zmdi-calendar-note zmdi-hc-lg"></i>{{ date('d M, Y', strtotime($blog->created_at)) }}</span>
                                    <span class="meta-comment"><i class="zmdi zmdi-comment-text zmdi-hc-lg"></i>In Progress</span>
                                </div>
                                <p class="card-text">{!! $blog->details !!}</p>
                                <a class="btn btn-primary" href="/blog/{{ $blog->id }}/edit">Edit</a>
                            </div>
                        </div>
                        ...
                        <div class="sidebar">
                            <div class="profile-intro card shadow  border-0 text-center">
                                ...
                                <div class="pi-content">
                                    ...
                                    <p class="card-text">On this page, Admin(s) will be able to view new blog uploaded and edit</p>
                                </div>
