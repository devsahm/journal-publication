            ...
            <div class="gx-wrapper">
                <div class="dashboard animated slideInUpTiny animation-duration-3">
                    <div class="page-heading d-sm-flex justify-content-sm-between align-items-sm-center">
                        <h2 class="title mb-3 mb-sm-0">WELCOME TO THE EDITORIAL DASHBOARD</h2>
                            ...
                            <div class="gx-card bg-teal accent-4 text-white">
                                <div class="row align-items-center">
                                    <div class="col-5">
                                        ...
                                        <span class="sub-heading text-white">Registered Authors</span>
                                    </div>
                                    <div class="col-7">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-5">
                                        <h1 class="chart-f30 font-weight-light mb-1">{{   $articles->count() }}</h1><span
                                            class="sub-heading text-white">Submitted Articles</span></div>
                                    <div class="col-7">
                        ...
                        <div class="col-xl-3 col-sm-6 col-12">
                           ...
                           <div class="col-xl-3 col-sm-6 col-12">
                            <div class="gx-card bg-purple text-white">
                                <div class="row align-items-center">
                                    <div class="col-5">
                                        <h1 class="chart-f30 font-weight-light mb-1">{{   $conferences->count() }}</h1><span
                                            class="sub-heading text-white">2019 Conference</span></div>
                                    <div class="col-7">
                                   <!--      <div id="ct-news-chart" class="height-100"></div> -->
                                    </div>
                                </div>
