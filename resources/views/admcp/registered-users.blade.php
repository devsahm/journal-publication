...
<!-- Mirrored from jumbo-admin.g-axon.work/cards-list-view.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Aug 2019 10:05:54 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="gx-wrapper">
                <div class="animated slideInUpTiny animation-duration-3">
                    <div class="page-heading d-sm-flex justify-content-sm-between align-items-sm-center">
                        <h2 class="title mb-3 mb-sm-0">Registered Authors</h2>
                        <nav class="mb-0 breadcrumb">
                            <a href="/admin" class="breadcrumb-item">Dashboard</a>
                            <span class="active breadcrumb-item">Registered-authors</span>
                        </nav>
                    </div>
                ...
                @foreach($writers as $writer)
                    ...
                    <div class="user-list d-flex flex-row  card shadow ">
                        @if($writer->image =='demo')
                        <img alt="alex-dolgove" src="/adminassets/images/userAvatar/demo.jpg"
                             class="user-avatar avatar-shadow">
                             @else
                             <img alt="alex-dolgove" src="/profileimage/{{ $writer->image }}"
                             class="user-avatar avatar-shadow">
                             @endif
                        ...
                        <div class="description">
                            ...
                            <h6>Writer</h6>
                            <p class="text-muted">
                                <i>Email:</i> {{ $writer->email }}<br>
                                @if($writer->phone== '')
                                <i>Phone Number:</i>  Not Available
                                @else
                                {{ $writer->phone }}
                                @endif
                            </p>
                            <ul class="list-inline d-sm-flex flex-sm-row jr-mbtn-list">
                               <!--  <li>
