        ...
        <div class="gx-main-content">
            ...
            <div class="gx-wrapper">
                <div class="page-heading d-sm-flex justify-content-sm-between align-items-sm-center">
                    <h2 class="title mb-3 mb-sm-0">NEWS</h2>
                    ...
                    <div class="col-lg-12">
                        <div class="gx-card">
                            <div class="gx-card-header">
                                <h3 class="card-title">Edit News Record</h3>
                            </div>
                            <div class="gx-card-body">
                               <form class="form" method="post" action="/ngo/newsngo/{{$newsngo->id}}" enctype="multipart/form-data">
                                @csrf
                                @method('PATCH')
                                @include('errors')
                                @include('success')      
                                @include('customerror')
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-2 col-sm-3 control-label">News Title<span style="color:red">*</span></label>
                                        <div class="col-md-10 col-sm-9">
                                            <input class="form-control" placeholder="New Title" type="text" name="title" value="{{$newsngo->title}}" required>
                                    ...
                                    <div class="line-dashed"></div>
                                     <div class="form-group row">
                                        ...
                                        <div class="col-md-10 col-sm-9">
                                        <textarea id="summernote" name="news_details">{{ $newsngo->news_details }}</textarea>  
