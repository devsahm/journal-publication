                        ...
                        <div class="col-md-12 col-12">
                            <div class="shadow border-0 card">
                                <div class="card-header">
                                  <span style="text-transform: uppercase;">Title: {{$eventngo->title}}</span>
                                </div>
                                <div class="card-body">
                                   
                           <h3 class="mb-4">Date: {{$eventngo->date}}</h3> 
                             <p class="mb-4" ><b></b> {{$eventngo->location}}</p>
                                    <h3>Event Details:</h3>
                                    <p class="card-text"> {!! $eventngo->event_details !!} </p>
                                    <h3>Uploaded mage:</h3>
                                    <img src="/ngogallery/{{$eventngo->image}}" width="400px">
