                        ...
                        <div class="col-md-12 col-12">
                            <div class="shadow border-0 card">
                                <div class="card-header">
                                  <span style="text-transform: uppercase;">Title: {{$newsngo->title}}</span>
                                </div>
                                <div class="card-body">
                                   
                         
                                    <p class="mb-4" ><b></b> {{$newsngo->location}}</p>
                                    <h3>Event Details:</h3>
                                    <p class="card-text"> {!! $newsngo->news_details !!} </p>
                                    <h3>Uploaded mage:</h3>
                                    <img src="/ngogallery/{{$newsngo->image}}" width="400px">
