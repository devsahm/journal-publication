            ...
            <div class="gx-wrapper">
                ...
                <div class="animated slideInUpTiny animation-duration-3">
                    ...
                    <div class="page-heading d-sm-flex justify-content-sm-between align-items-sm-center">
                        <h2 class="title mb-3 mb-sm-0">Executive Details</h2>
                        <nav class="breadcrumb">
                            <a href="/state" class="breadcrumb-item">Dashboard</a>
                        
                            <span class="active breadcrumb-item">{{$exestate->position}}</span>
                        </nav>
                    </div>
                        ...
                        <div class="col-md-12 col-12">
                            <div class="shadow border-0 card">
                                <div class="card-header">
                                  <span style="text-transform: uppercase;">{{$exestate->position}}</span>
                                </div>
                                <div class="card-body">
                                    <h2 class="mb-4"><b>Name:</b> {{$exestate->name}}</h2> 
                          
                                    
                                    <p class="card-text"> {!! $exestate->profile !!} </p>
