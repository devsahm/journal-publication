            ...
            <div class="gx-wrapper">
                <div class="dashboard animated slideInUpTiny animation-duration-3">
                    <div class="page-heading d-sm-flex justify-content-sm-between align-items-sm-center">
                        <h2 class="title mb-3 mb-sm-0"><span style="text-transform: uppercase;"><b>{{ Auth::guard('ngo')->user()->name }} </span> ADMIN DASHBOARD</b> </h2>
                        ...
                        <div class="col-xl-3 col-sm-6 col-12">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-5">
                                        <h1 class="chart-f30 font-weight-light mb-1">{{ $events->count() }}</h1><span
                                            class="sub-heading text-white">Uploaded Events</span></div>
                                    <div class="col-7">
                         ...
                         <div class="col-xl-3 col-sm-6 col-12">
                            <div class="gx-card bg-purple text-white">
                                <div class="row align-items-center">
                                    <div class="col-5">
                                        <h1 class="chart-f30 font-weight-light mb-1">
                                            @if($infos->count())
                                             Updated
                                              @else
                                              Not Updated
                                            ...
                                            class="sub-heading text-white">Header/Footer Info</span></div>
                          ...
                          <div class="col-xl-3 col-sm-6 col-12">
                            <div class="gx-card bg-red text-white">
                                <div class="row align-items-center">
                                    <div class="col-5"><h1 class="chart-f30 font-weight-light mb-1">  {{ $sliders->count() }}</h1><span
                           ...
                           <div class="col-xl-3 col-sm-6 col-12">
                            <div class="gx-card bg-red text-white">
                                <div class="row align-items-center">
                                    <div class="col-5"><h1 class="chart-f30 font-weight-light mb-1">{{ $news->count() }}</h1><span
                                            class="sub-heading text-white">Uploaded News</span></div>
                                    <div class="col-7">
                                      <!--   <canvas id="doughnut-chart" class="height-100" height="150"></canvas> -->
                                    </div>
                                </div>
