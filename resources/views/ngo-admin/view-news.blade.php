            ...
            <div class="gx-wrapper">
                <div class="animated slideInUpTiny animation-duration-3">
                    <div class="page-heading d-sm-flex justify-content-sm-between align-items-sm-center">
                        <h2 class="title mb-3 mb-sm-0">{{ Auth::guard('ngo')->user()->name }} News Lists</h2>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-users default-table table-hover">
                                            ...
                                            <td>{{ date('d M Y', strtotime($new->created_at)) }}</td>
                                                <td>
                                                  <div>
                                                    <a href="/ngo/newsngo/{{ $new->id }}" class="btn btn-info" ><i class="fa fa-eye"></i>View</a>
                                                </div>
                                                </td>
                                
                                                <td><a href="/ngo/newsngo/{{ $new->id }}/edit" class="btn btn-primary">Edit</a></td>

                                        
                                                <td class="text-center">
                                                <form method="post" action="/ngo/newsngo/{{ $new->id }}">
                                                 @method('DELETE')
                                                 @csrf
