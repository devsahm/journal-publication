        ...
        <div class="gx-main-content">
            ...
            <div class="gx-wrapper">
                <div class="page-heading d-sm-flex justify-content-sm-between align-items-sm-center">
                    <h2 class="title mb-3 mb-sm-0">Edit Event</h2>
                    <nav class="mb-0 breadcrumb">
                        <a href="/admin" class="breadcrumb-item">Dashboard</a>
                        <a href="/admin/events-list" class="breadcrumb-item">Events</a>
                       
                        <span class="active breadcrumb-item">Edit Event</span>
                    </nav>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="gx-card">
                            ...
                            <div class="gx-card-body">
                                ...
                                @include('errors')
                                @include('success')
                               <form class="form" method="post" action="/event/{{ $event->id }}" enctype="multipart/form-data">
                                @method('PATCH')
                                @csrf
                                     ...
                                     <div class="line-dashed"></div>
                                      ...
                                      <div class="form-group row">
                                        ...
                                        <div class="col-md-10 col-sm-9">
                                         <input type="text" name="date" class="form-control" placeholder="Day Month Year - Day Month Year" value="{{ $event->date }}">
                                        </div>
                                         </div>
                                    ...
                                    <div class="line-dashed"></div>
                                     <div class="form-group row">
                                        ...
                                        <div class="col-md-10 col-sm-9">
                                          <textarea id="summernote" name="details">{{ $event->details }}</textarea>
                                        </div>
                                    </div>          
