        ...
        <div class="gx-main-content">
            ...
            <div class="gx-wrapper">
                <div class="page-heading d-sm-flex justify-content-sm-between align-items-sm-center">
                    <h2 class="title mb-3 mb-sm-0">EDIT EXECUTIVE</h2>
                    <nav class="mb-0 breadcrumb">
                        <a href="/state" class="breadcrumb-item">Dashboard</a>
                       
                        <span class="active breadcrumb-item">Edit Executive</span>
                    </nav>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="gx-card">
                            ...
                            <div class="gx-card-body">
                               <form class="form" method="post" action="/state/exestate/{{$exestate->id}}">
                                @csrf
                                @method('PATCH')
                                @include('errors')
                                @include('success')      
                                @include('customerror')
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-2 col-sm-3 control-label">Name<span style="color:red">*</span></label>
                                        <div class="col-md-10 col-sm-9">
                                            <input class="form-control" placeholder="Name" type="text" name="name" value="{{ $exestate->name }}" required>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-2 col-sm-3 control-label">Select Position<span style="color:red">*</span></label>
                                        <div class="col-md-10 col-sm-9">
                                            <select class="custom-select" name="position" required disabled>
                                        ...
                                        <div class="line-dashed"></div>
                                     <div class="form-group row">
                                        <label class="col-md-2 col-sm-3 control-label">Brief Profile<span style="color:red">*</span></label>
                                        <div class="col-md-10 col-sm-9">
                                    <textarea id="summernote" name="profile">{{ $exestate->profile }}</textarea>  
