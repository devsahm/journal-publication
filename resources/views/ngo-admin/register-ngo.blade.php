                ...
                <div class="login-container d-flex justify-content-center align-items-center animated slideInUpTiny animation-duration-3">
                    <div class="login-content">
                        <div class="login-header">
                            ...
                            <h4 style="text-align: center;">CREATE NGO</h4>
                           ...
                           <form method="POST" action='{{ url("register/$url") }}' aria-label="{{ __('Register') }}">
                            ...
                            @include('success')
                                <fieldset>
                                    ...
                                    <input id="" type="text" class="form-control form-control-lg{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" Placeholder="Full NGO's Name" value="{{ old('name') }}" required>
