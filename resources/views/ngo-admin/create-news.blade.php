            ...
            <div class="gx-wrapper">
                <div class="page-heading d-sm-flex justify-content-sm-between align-items-sm-center">
                    ...
                    <nav class="mb-0 breadcrumb">
                        ...
                        <span class="active breadcrumb-item">Add News </span>
                    </nav>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="gx-card">
                            ...
                            <div class="gx-card-body">
                               <form class="form" method="post" action="/ngo/newsngo" enctype="multipart/form-data">
                                @csrf
                                @include('errors')
                                @include('success')      
                                @include('customerror')
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-2 col-sm-3 control-label">Title<span style="color:red">*</span></label>
                                        <div class="col-md-10 col-sm-9">
                                            <input class="form-control" placeholder="News Title" type="text" name="title" value="{{old('title')}}" required>       
                                        </div>
                                    </div>
                                    ...
                                    <div class="line-dashed"></div>
                                     <div class="form-group row">
                                        ...
                                        <div class="col-md-10 col-sm-9">
                                        <textarea id="summernote" name="news_details">{{old('news_details')}}</textarea>  
