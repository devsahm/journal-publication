            ...
            <div class="gx-wrapper">
                <div class="dashboard animated slideInUpTiny animation-duration-3">
                    <div class="page-heading d-sm-flex justify-content-sm-between align-items-sm-center">
                        <h2 class="title mb-3 mb-sm-0">WELCOME TO THE MEMBERSHIP ADMIN DASHBOARD</h2>
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-sm-6 col-12">
                            <div class="gx-card bg-red text-white">
                                <div class="row align-items-center">
                                    <div class="col-5"><h1 class="chart-f30 font-weight-light mb-1">{{ $licenses->count() }}</h1><span
                                            class="sub-heading text-white">Practicing License Application</span></div>
                                    <div class="col-7">
                        ...
                        <div class="col-xl-3 col-sm-6 col-12">
                            <div class="gx-card bg-brown text-white">
                                <div class="row align-items-center">
                                    <div class="col-5">
                                        <h1 class="chart-f30 font-weight-light mb-1">{{ $summary->count() }}</h1><span
                                            class="sub-heading text-white">Membership Registration</span></div>
                                    <div class="col-7">
                         ...
                         <div class="col-xl-3 col-sm-6 col-12">
                            <div class="gx-card bg-green text-white">
                                <div class="row align-items-center">
                                    <div class="col-5"><h1 class="chart-f30 font-weight-light mb-1">{{ $subscriptions->count() }}</h1><span
                                            class="sub-heading text-white">Subscribed Email</span></div>
                                    <div class="col-7">
                                      <!--   <canvas id="doughnut-chart" class="height-100" height="150"></canvas> -->
                                    </div>
                                </div>
                          ...
                          <div class="col-xl-3 col-sm-6 col-12">
                            <div class="gx-card bg-purple text-white">
                                <div class="row align-items-center">
                                    <div class="col-5">
                                        <h1 class="chart-f30 font-weight-light mb-1">{{ $states->count() }}</h1><span
                                            class="sub-heading text-white">State Chapters</span></div>
                                    <div class="col-7">
                                   <!--      <div id="ct-news-chart" class="height-100"></div> -->
                                    </div>
                                </div>
                          ...
                          <div class="col-xl-3 col-sm-6 col-12">
                            <div class="gx-card bg-blue text-white">
                                <div class="row align-items-center">
                                    <div class="col-5"><h1 class="chart-f30 font-weight-light mb-1">{{ $ngos->count() }}</h1><span
                                            class="sub-heading text-white">Ngos Created</span></div>
                                    <div class="col-7">
                                      <!--   <canvas id="doughnut-chart" class="height-100" height="150"></canvas> -->
                                    </div>
                                </div>
