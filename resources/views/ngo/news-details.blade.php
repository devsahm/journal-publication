				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<ol class="tg-breadcrumb">
							<li><a href="/{{$profile->username}}-ngo">Home</a></li>
							<li><a href="/{{$profile->username}}-ngo/news">News</a></li>
							<li class="tg-active">New Details</li>
						</ol>
					</div>
				</div>
			</div>
								...
								<div class="tg-detailpage tg-eventdetailpage">
									<article class="tg-themepost tg-eventpost">
										<div class="tg-themepostcontent">
											...
											<div class="tg-themeposttitle"><h1>{{ $newsdetails->title}}</h1></div>
											<ul class="tg-themepostinfo">
												<li>
													<div class="tg-infodata">
														<span>Date Posted:</span>
														<strong><a href="javascript:void(0);">{{ date('d M, Y', strtotime($newsdetails->created_at)) }}</a></strong>
													</div>
												</li>
										...
										<figure class="tg-featuredimg"><img src="/ngogallery/{{ $newsdetails->image}}" alt="image description" width="100%"></figure>
									<!-- 	<div id="tg-eventcounter" class="tg-eventcounter tg-counter"></div> -->
									<br><br><br>
										<div class="" style="">
											
											<p>{!! $newsdetails->event_details !!}</p>
										...
										<article class="tg-campus tg-campusleftthumb">
											...
											<div class="tg-campuscontent">
												...
												<div class="tg-campustitle">
													<h3><a href="/{{$profile->username}}-ngo/events/{{$sideevent->slug}}">{{ $sideevent->title }}</a></h3>
												</div>
											</div>
										</article>
										@endforeach
								...
								<div class="tg-widgetcontent">
									<ul style="list-style-type: circle;">
										<li>
											...
											<p class=""><a href="/{{$profile->username}}-ngo/events/event-details/{{ $event->slug}}">{{$event->title}}</a></p>
										    @endforeach
										    @else
