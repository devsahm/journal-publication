				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<div class="tg-navigationarea">
							<strong class="tg-logo"><a href="/{{$profile->username}}-ngo"><img src="/ngogallery/{{$ngoinfo->logo}}" style="width: 50px;" alt="logo"></a></strong>
							...
							<aside id="tg-sidebar" class="tg-sidebar">
								<div class="tg-widget tg-widgetaboutusnav">
									...
									<div class="tg-widgetcontent">
										<ul>
											<li class="tg-active"><a href="/vision">Vision</a></li>
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-9">
							<div id="tg-content" class="tg-content">
								...
								<div class="tg-aboutus tg-visionmission">
									<figure><img src="/ngogallery/{{$about->image}}"  style="width: 100%" alt="image description"></figure>
									<!-- <h3>Our Vision</h3> -->
									<p>{!! $about->content !!} </p>
