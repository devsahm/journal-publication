						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<ul class="tg-addressinfo">
								<li>
									...
									<address>wfwefwefefef</address>
								<li>
									<i class="icon-phone-handset"></i>
									<span>efefefefedfwdwdfwf</span>
								</li>
							</ul>
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						...
						<!--  -->
							...
							<li class="tg-active">Event Search List</li>
						</ol>
					</div>
				</div>
			</div>
							...
							<div id="tg-content" class="tg-content">
								<div class="tg-resultandstyle">
									...
									<ul class="tg-poststyleswitcher">
										<li class="tg-active"><a href="javascript:void(0);"><i class="fa fa-th"></i></a></li>
											...
											<article class="tg-themepost tg-eventpost">
												...
												<div class="tg-themepostcontent">
													...
													<div class="tg-themeposttitle">
														<h3><a href="/{{$profile->username}}-ngo/events/event-details/{{ $event->id}}">{{ $event->title }}</a></h3>
													</div>
													...
													<div class="tg-btnsbox">
														<a class="tg-btn" href="/{{$profile->username}}-ngo/events/event-details/{{ $event->slug }}">read more</a>
													</div>
												</div>
											</article>
											@endforeach
							...
							<aside id="tg-sidebar" class="tg-sidebar">
								<div class="tg-widget tg-widgetsearchcourse">
									...
									<div class="tg-widgetcontent">
										<form class="tg-formtheme tg-formsearchcourse" action="/{{$profile->username}}-ngo/eventsearch" method="get">
											<fieldset>
								...
								<div class="tg-widget tg-widgetlatestcourses">
									...
									<div class="tg-widgetcontent">
											...
											@if($eventsidebars->count())
										@foreach($eventsidebars as $eventsidebar )
										<article class="tg-campus tg-campusleftthumb">
											<figure class="tg-featuredimg">
												<a href="javascript:void(0);">
													<img src="/ngogallery/{{ $eventsidebar->image }}" alt="image description" style="width: 70px; height: 70px;">
												</a>
											</figure>
											<div class="tg-campuscontent">
												<div class="tg-datetime">
													<i class="fa fa-calendar"></i>
													<span>{{ date('d M, Y', strtotime($eventsidebar->created_at)) }}</span>
												</div>
												<div class="tg-campustitle">
													<h3><a href="/{{$profile->username}}-ngo/event/event-details/{{ $eventsidebar->id}}">{{ $eventsidebar->title }}</a></h3>
												</div>
											</div>
										</article>
										@endforeach
