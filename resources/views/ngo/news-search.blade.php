				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						...
						<!--  -->
							...
							<li class="tg-active">News Search List</li>
						</ol>
					</div>
				</div>
			</div>
						...
						<div class="col-xs-12 col-sm-8 col-md-9 col-lg-9 pull-right">
							<div id="tg-content" class="tg-content">
								<div class="tg-resultandstyle">
									<span class="tg-searchresult">News Search List</span>
											...
											<article class="tg-themepost tg-eventpost">
												...
												<div class="tg-themepostcontent">
													...
													<div class="tg-themeposttitle">
														<h3><a href="/{{$profile->username}}-ngo/news/event-details/{{ $new->id}}">{{ $new->title }}</a></h3>
													</div>
							...
							<aside id="tg-sidebar" class="tg-sidebar">
								<div class="tg-widget tg-widgetsearchcourse">
									...
									<div class="tg-widgetcontent">
										<form class="tg-formtheme tg-formsearchcourse" action="/{{$profile->username}}-ngo/newsearch" method="get">
											<fieldset>
								...
								<div class="tg-widget tg-widgetlatestcourses">
									...
									<div class="tg-widgetcontent">
											...
											@if($newsidebars->count())
										@foreach($newsidebars as $newsidebar )
										<article class="tg-campus tg-campusleftthumb">
											<figure class="tg-featuredimg">
												<a href="javascript:void(0);">
													<img src="/ngogallery/{{ $newsidebar->image }}" alt="image description" style="width: 70px; height: 70px;">
												</a>
											</figure>
											<div class="tg-campuscontent">
												<div class="tg-datetime">
													<i class="fa fa-calendar"></i>
													<span>{{ date('d M, Y', strtotime($newsidebar->created_at)) }}</span>
												</div>
												<div class="tg-campustitle">
													<h3><a href="/{{$profile->username}}-ngo/news/{{ $newsidebar->slug}}">{{ $newsidebar->title }}</a></h3>
												</div>
											</div>
										</article>
										@endforeach
