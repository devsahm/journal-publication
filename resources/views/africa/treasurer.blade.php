				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<ol class="tg-breadcrumb">
							<li><a href="/">Home</a></li>
							<li class="tg-active">Treasurer</li>
						</ol>
					</div>
				</div>
			</div>
						...
						<div class="col-xs-12 col-sm-8 col-md-9 col-lg-9">
							<div id="tg-content" class="tg-content">
								<div class="tg-faculy tg-facultydetail">
									<figure><img src="/assets/images/speakers/img-14.jpg" alt="image description"></figure>
									<div class="tg-facultycontent">
										...
										<div class="tg-facultyname">
											<h3>Dr. Grace Ronke Awopetu</h3>
										</div>
										<span class="tg-facultydesignation">TREASURER</span>
										<div class="tg-description">
											<p>Awopetu  Ronke Grace  was born in 4th January 1974.  She is a Senior Lecturer in Psychology at The Benue State University Markudi. She bagged her first degree from The Ekiti State University in 2000, M. Sc .from the same university in 2004, and PhD from university of Ibadan in 2012. She is a fellow in the Nigerian Association of Clinical Psychologists. </p>
										</div>
										<ul class="tg-contactinfo">
											<li>
												<i class="icon-phone-handset"></i>
												<span>07031535566</span>
											</li>
											
											<li>
												<a href="mailto:awopeturonke@gmail.com">
													<i class="icon-envelope"></i>
													<span>awopeturonke@gmail.com 
													</span>
												
												</a>
											</li>
											<li>
												<a href="mailto:ronkemiowon@yahoo.com">
													<i class="icon-envelope"></i>
													<span>ronkemiowon@yahoo.com
													</span>
