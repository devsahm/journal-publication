...
<head>
	...
	<title>Nigerian Association of Clinical Psychologies</title>
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<ol class="tg-breadcrumb">
							<li><a href="/">Home</a></li>
							<li class="tg-active">Financial Secretary</li>
						</ol>
					</div>
				</div>
			</div>
						...
						<div class="col-xs-12 col-sm-8 col-md-9 col-lg-9">
							<div id="tg-content" class="tg-content">
								<div class="tg-faculy tg-facultydetail">
									<figure><img src="/assets/images/speakers/img-15.jpg" alt="image description"></figure>
									<div class="tg-facultycontent">
										...
										<div class="tg-facultyname">
											<h3>Rev Sis. Chinwendu Cecilia Nduaguba</h3>
										</div>
										<span class="tg-facultydesignation">FINANCIAL SECRETARY</span>
										<div class="tg-description">
											<p>Rev. Sr. EHJ CECILIA Chinwendu NDUAGUBA is an indigene of Oraukwu of Idemili North Local Government Area of Anambra State. She completed her secondary education in 1984 and proceeded for her N.C.E. at the University of Benin now Delta State University Agricultural Science (Double Major) in 1988.  She obtained her B.Sc from the Central State University, Wilberforce, Ohio in 2000. In between she acquired Certificate in Gaudium Et Spes (TeenStar Trainer) in 2007 and Certificate in Gauduim Et Spes (Pastoral Counselor) in 2009 both in Abuja. With her passion for education, she recieved Master of Science in Clinical Psychology at the University of Ibadan, Ibadan in 2015. Furthermore her love for knowledge led her to registere for her PhD (Suspended) at the University of Ibadan, Ibadan in 2016. With her wide working experiences, she taught in many States of the Federation and currently a Principal at St. Patrick Secondary School, Illela, Sokoto State from 2018 till date.</p>
										</div>
										<ul class="tg-contactinfo">
											<li>
												<i class="icon-phone-handset"></i>
												<span>08056681636</span>
											</li>
											
											<li>
												<a href="mailto:chiliandu@yahoo.com">
													<i class="icon-envelope"></i>
													<span>chiliandu@yahoo.com</span>
												</a>
											</li>
										</ul>
