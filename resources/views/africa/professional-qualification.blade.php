									...
									<div class="tg-widgetcontent">
										<ul>
											...
											<li>
												...
												<li>
												<a href="/membership/professional-qualification" style="color: green;">
							...
							<div id="tg-content" class="tg-content">
								<div class="tg-jobs">
									...
									<div class="tg-heading">
										<h2>Professional Training Attended</h2>
									</div>
									@include('success')
             						@include('errors')
								    ...
								    <div class="row">
								    	  <p class="col-md-12">Indicate those professional training you attended starting from the highest and attach a copy of the corresponding certificate</p>
								...
								@endif
									...
									<form method="post" action="/training" enctype="multipart/form-data">
										...
										<div class="form-group">
											<p>Name of Organisers</p>
											<input type="text" name="organisers" placeholder="" class="form-control" value="" required>
