				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						...
						<!--  -->
							...
							<li class="tg-active">{{ucfirst($state->state)}} State Event Search List</li>
						</ol>
					</div>
				</div>
			</div>
							...
							<aside id="tg-sidebar" class="tg-sidebar">
								<div class="tg-widget tg-widgetsearchcourse">
									...
									<div class="tg-widgetcontent">
										<form class="tg-formtheme tg-formsearchcourse" action="/{{$state->state}}-state/eventsearch" method="get">
											<fieldset>
								...
								<div class="tg-widget tg-widgetlatestcourses">
									...
									<div class="tg-widgetcontent">
										...
										<article class="tg-campus tg-campusleftthumb">
											<figure class="tg-featuredimg">
												<a href="javascript:void(0);">
													<img src="/stategallery/{{ $eventsidebar->image }}" alt="image description" style="width: 70px; height: 70px;">
												</a>
											</figure>
											<div class="tg-campuscontent">
												...
												<div class="tg-campustitle">
													<h3><a href="/{{$state->state}}-state/events/event-details/{{ $event->id}}">{{ $eventsidebar->title }}</a></h3>
												</div>
											</div>
										</article>
										@endforeach
