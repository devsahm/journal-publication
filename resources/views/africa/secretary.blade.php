				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<ol class="tg-breadcrumb">
							<li><a href="/">Home</a></li>
							<li class="tg-active">Secretary</li>
						</ol>
					</div>
				</div>
			</div>
						...
						<div class="col-xs-12 col-sm-8 col-md-9 col-lg-9">
							<div id="tg-content" class="tg-content">
								<div class="tg-faculy tg-facultydetail">
									<figure><img src="/assets/images/speakers/img-12.jpg" alt="image description"></figure>
									<div class="tg-facultycontent">
										...
										<div class="tg-facultyname">
											<h3>Dr. Olugbemi Olukolade</h3>
										</div>
										<span class="tg-facultydesignation">NATIONAL SECRETARY</span>
										<div class="tg-description">
											<p>Dr Olukolade is a thorough-bred clinical psychologist and psychotherapist with more than 13 years professional experience in providing psychological care for diverse disorders. He has trainings in Cognitive behavioral therapy (CBT), Behavior Family Therapy (BFT), Exposure Therapy, Couple's Therapy, Sex Therapy, Anger Management and Addiction related management. </p>

											<p>He believes strongly in psychological testing and is adept in the uses of various tests especially neuro-psychological tests, personality tests, career assessment tests, test of language etc.Dr Olukolade has a very strong grounding in the management of home life issues and this has spurred his interests in Couples therapy, Couples in distress therapy and Couples with irreconcilable differences therapy, with great results.</p>

											<p>
											Recently Dr Olukolade had been consistently consulting for schools, institutions and corporate organizations around the country and West-African region in terms of educational needs of schools, improved teaching skills for teachers and Employee Assistance Programs in multinational organizations with the sole interest of helping people become the best they can be. Also, he is a regular feature on many radio talk shows especially on Inspiration 100.5 FM (Sharing Life Issues). He is a sought after public speaker at institutions, churches and conferences</p>
 
											<p>Dr Olukolade is a recipient of the famous Commonwealth scholarship in the United Kingdom, (Birmingham & Solihull NHS).Dr Olukolade is the head of clinical psychology department, UCH, Ibadan and Consultant Clinical Psychologist at Diamondmoor Psychological Consult and Services, Ibadan.
											</p>
										</div>
										<ul class="tg-contactinfo">
											<li>
												<i class="icon-phone-handset"></i>
												<span>08036701284</span>
											</li>
											
											<li>
												<a href="mailto:gbemmydiamond@yahoo.com">
													<i class="icon-envelope"></i>
													<span>gbemmydiamond@yahoo.com</span>
												</a>
											</li>
										</ul>
