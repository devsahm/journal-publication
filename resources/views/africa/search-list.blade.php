				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<ol class="tg-breadcrumb">
							<li><a href="/">Home</a></li>
							<li class="tg-active">Search Result</li>
						</ol>
					</div>
				</div>
			</div>
										...
										<form class="tg-formtheme tg-formsearchcourse" method="get" action="/search">
											<fieldset>
												<div class="tg-inputwithicon">
													<i class="icon-book"></i>
													<input type="search" name="search" class="form-control" placeholder="seach by author, title or keywords">
												</div>
										...
										@if($articles->count())
					   					@foreach(articles as $article)
												...
												<div class="tg-themepostcontent">
													...
													<div>
														<p><a href="/publication/article-detials/{{ $article->id }}" style="text-decoration: underline; font-size: 15px; color: black;" >{{ $article->title }}</a></p>
													</div>
