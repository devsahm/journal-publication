						...
						<div class="col-xs-12 col-sm-8 col-md-9 col-lg-9">
							<div id="tg-content" class="tg-content">
								<div class="tg-faculy tg-facultydetail">
									<figure><img src="/assets/images/speakers/img-10.jpg" alt="image description"></figure>
									<div class="tg-facultycontent">
										...
										<div class="tg-facultyname">
											<h3>Prof. Harry Obi-Nwosu</h3>
										</div>
										<span class="tg-facultydesignation">VICE PRESIDENT</span>
										<div class="tg-description">
											<p>Pro. Harry Obi-Nwosu is an erudite clinical psychologist lecturer and the current Head Of  Psychology Department Nnamdi Azikiwe University, Awka Anambra State. He bagged hi s M.Sc. in clinical psychology from the same institution in       1999, and his PHd  in 2005.</p>
										</div>
										<ul class="tg-contactinfo">
											...
											<li>
												<a href="mailto:royaldioka@gmail.com">
													<i class="icon-envelope"></i>
													<span>royaldioka@gmail.com</span>
												</a>
											</li>
										</ul>
