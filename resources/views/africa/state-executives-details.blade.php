				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<ol class="tg-breadcrumb">
							<li><a href="/{{$state->state}}-state">Home</a></li>
							<li class="tg-active">{{$executive->position}}</li>
						</ol>
					</div>
				</div>
			</div>
										...
										<article class="tg-campus tg-campusleftthumb">
											<figure class="tg-featuredimg">
												<a href="javascript:void(0);">
													<img src="/stategallery/{{ $event->image }}" alt="image description" style="width: 70px; height: 70px;">
												</a>
											</figure>
							...
							<div id="tg-content" class="tg-content">
								<div class="tg-faculy tg-facultydetail">
									...
									<div class="tg-facultycontent">
										...
										<span class="tg-facultydesignation">THE STATE CHAPTER {{strtoupper($executive->position)}}</span>
