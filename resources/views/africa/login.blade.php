						...
						<div class="tg-contactus tg-contactusvone">
							...
							<div class="row">
								...
								<div class="col-md-6">
										...
										@include('customerror')
                          			   @isset($url)
                       				 <form method="POST" action='{{ url("login/$url") }}' aria-label="{{ __('Login') }}" class="tg-formtheme tg-formcontactus">
										...
										<p> Don't have an account? <a href="/register/writer"> REGISTER</a> now</p>
									</form>
								</div>
									<div class="col-md-3"></div>
							</div>
