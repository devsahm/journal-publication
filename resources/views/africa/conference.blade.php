				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<ol class="tg-breadcrumb">
							...
							<li class="tg-active">Conference 2019</li>
						</ol>
					</div>
				</div>
			</div>
							...
							<div id="tg-content" class="tg-content">
								<div class="tg-jobs">
									...
									<div class="tg-heading">
										<h2>Submit Abstract/Poster Summary</h2>
									</div>
										@include('success')
             						@include('errors')
									<div class="tg-themecollapsecontent">
								
									<form method="post" action="/conference" enctype="multipart/form-data">
										@csrf
									<div class="form-group">
										...
										<div class="form-group">
											<input type="text" name="title" placeholder="Paper Title" class="form-control" value="{{ old('title') }}">
										</div>
										...
										<div class="form-group">
											<span> Attach paper (pdf, doc & docx)</span>
