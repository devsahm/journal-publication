				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<ol class="tg-breadcrumb">
							<li><a href="/">Home</a></li>
							<li class="tg-active">Publicity Secretary</li>
						</ol>
					</div>
				</div>
			</div>
						...
						<div class="col-xs-12 col-sm-8 col-md-9 col-lg-9">
							<div id="tg-content" class="tg-content">
								<div class="tg-faculy tg-facultydetail">
									<figure><img src="/assets/images/speakers/img-16.jpg" alt="image description"></figure>
									<div class="tg-facultycontent">
										...
										<div class="tg-facultyname">
											<h3>Mr. Joseph  Kiba</h3>
										</div>
										<span class="tg-facultydesignation">PUBLICITY SECRETARY</span>
										<div class="tg-description">
											<p>Mr. Joseph  Kiva. Is a clinician. He works with the federal medical centre markudi. He bagged his bachelor’s degree from The Benue State University in 2008, and M.Sc. from the same University in 2015.</p>
										</div>
										<ul class="tg-contactinfo">
											<li>
												<i class="icon-phone-handset"></i>
												<span>08067779252</span>
											</li>
											
											<li>
												<a href="mailto:topewuteji@yahoo.com">
													<i class="icon-envelope"></i>
													<span>mcdevelop13@gmail.com</span>
												</a>
											</li>
										</ul>
