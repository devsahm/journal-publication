				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<ol class="tg-breadcrumb">
							<li><a href="/">Home</a></li>
							<li class="tg-active">Vice Secretary</li>
						</ol>
					</div>
				</div>
			</div>
						...
						<div class="col-xs-12 col-sm-8 col-md-9 col-lg-9">
							<div id="tg-content" class="tg-content">
								<div class="tg-faculy tg-facultydetail">
									<figure><img src="/assets/images/speakers/img-13.jpg" alt="image description"></figure>
									<div class="tg-facultycontent">
										...
										<div class="tg-facultyname">
											<h3>Dr. Shimakaa Iorlumum  Andrew</h3>
										</div>
										<span class="tg-facultydesignation">VICE SECRETARY</span>
										<div class="tg-description">
											<p>Dr Shimakaa Iorlumun Andrew was born on the 9th September 1982. He had his first degree in Psychology from Benue State University Makurdi in 2005, and M.sc and PhD degrees from the same University in 2014 and 2019 respectively. He specializes in psychotherapy. He has attended several conferences and and workshops, continuous Development programmes on various areas of psychology and development. He is a member of Nigerian Psychological Association (NPA), Nigerian Association of Clinical Psychologists (NACP). He is a practicing Clinical psychologists with Federal Medical Centre Makurdi and also the State secretary of Nigerian Psychological Association.</p>
										</div>
								<!-- 		<ul class="tg-contactinfo">
											...
											<li>
												<a href="mailto:topewuteji@yahoo.com">
													<i class="icon-envelope"></i>
													<span>topewuteji@yahoo.com</span>
												</a>
											</li>
										</ul> -->
