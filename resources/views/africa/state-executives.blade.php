				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<ol class="tg-breadcrumb">
							<li><a href="/{{$state->state}}-state">home</a></li>
							<li class="tg-active">{{ucfirst($state->state)}} State Executives</li>
						</ol>
					</div>
				</div>
			</div>
						...
						<div class="col-xs-12 col-sm-8 col-md-12 col-lg-12">
							<div id="tg-content" class="tg-content">
								<div class="tg-results">
									<!-- <span class="tg-lastmodified">Last Modified: February 26, 2017</span> -->
									<div class="tg-pagetitle">
										<h2>{{ucfirst($state->state)}} State Executives</h2>
									</div>
									<div class="tg-resultcategory">
										...
										<ul class="tg-downloadlist">
											...
											<li>
												<div class="tg-result">
													<span class="tg-counting"><?php echo $counter; ?></span>
													<a class="tg-btndownloadresult" href="/{{$state->state}}-state/executives/{{$executive->id}}">
														<em>Read More</em>
														<i class="icon-eye"></i>
													</a>
													<div class="tg-description"><p>{{$executive->position}}- {{$executive->name}}</p></div>
												</div>
												<?php $counter++; ?>
											</li>
											...
											@endforeach
											@else
											<p class="alert alert-warning">No result was found</p>
											@endif
