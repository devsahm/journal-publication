                        ...
                        <div class="col-md-12 col-12">
                            <div class="shadow border-0 card">
                                <div class="card-header">
                                   Volume {{ $issue->volume_id }} Issue {{ $issue->issue }}({{ $issue->month }})
                                </div>
                                <div class="card-body">
                                ...
                                <li>
                                    <h2><a class="mb-4" href="/article/{{ $article->id }}" style="text-decoration: none;">{{ $article->title }}</a></h2>
                                    
                                    <h5>Abstract:</h5>
                                    <p class="card-text">{!! \Illuminate\Support\Str::words($article->abstract, 60,'....')  !!}</p>
                                </li>
                                <br>
                                @endforeach
<!-- 
