                        ...
                        <div class="module-side">
                            ...
                            <div class="module-side-content">
                                <div class="module-side-scroll custom-side-scrollbar" style="position: relative;">
                                    ...
                                    <ul class="module-nav">
                                        <li>
                                            <a href="/admin/contact-mail" class="active">
                    ...
                    <div class="module-box">
                        ...
                        <div class="module-box-content">
                           @include('success')
                             ...
                             <a href="/contacts/{{$contact-> id}}" style="text-decoration: none; color: #323232;">
                                ...
                                <div class="custom-scrollbar module-list-scroll" style="position: relative;">
                                    ...
                                    @else
                                      ...
                                      <div class="alert alert-warning">
                                                ...
                                                <p style="">No message record was found</p>
