            ...
            <div class="gx-wrapper">
                <div class="animated slideInUpTiny animation-duration-3">
                    <div class="page-heading d-sm-flex justify-content-sm-between align-items-sm-center">
                        <h2 class="title mb-3 mb-sm-0">Upload News</h2>
                        <nav class="mb-0 breadcrumb">
                            <a href="/admin" class="breadcrumb-item">Dashboard</a>
                          
                            <span class="active breadcrumb-item">Upload News</span>
                        </nav>
                    </div>
                 ...
                 <form method="post" action="/blog" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <input type="text" name="title" class="form-control" placeholder="Title*" value="{{ old('title') }}" style="padding: 10px;" required>
                    </div>

                    <div class="form-group">
                        <label>Upload Image(maximum image size of 2mb)</label>
                        <input type="file" class="form-control" id="exampleInputSubject" placeholder="Subject" style="padding: 10px;" name="image" required>
                    </div>
