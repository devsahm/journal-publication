            ...
            <div class="gx-wrapper">
                ...
                <div class="animated slideInUpTiny animation-duration-3">
                    ...
                    <div class="page-heading d-sm-flex justify-content-sm-between align-items-sm-center">
                        <h2 class="title mb-3 mb-sm-0">News Details</h2>
                        <nav class="breadcrumb">
                            <a href="/admin" class="breadcrumb-item">Dashboard</a>
                        
                            <span class="active breadcrumb-item">News Details</span>
                        </nav>
                    </div>

                    <div class="row">
                    <div class="col-xl-8 col-md-12 col-sm-6 col-12">
                    ...
                    <div class="row mb-md-12">
                        <div class="col-md-12 col-12">
                            <div class="shadow border-0 card">
                                ...
                                <div class="card-body">
                                    <h2 class="mb-4"><b>Title:</b> {{$blog->title}}</h2> 
                                    <h6 class="card-subtitle mb-4"><b>News Details</b></h6>
                                    <p class="card-text"> {!! $blog->details !!}</p>
                                 

                                    <a href="/uploads/{{$blog->id}}" class="gx-btn gx-btn-sm gx-btn-primary">Edit</a>
