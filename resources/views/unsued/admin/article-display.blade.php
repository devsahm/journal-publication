                        ...
                        <div class="col-md-12 col-12">
                            <div class="shadow border-0 card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="/uploads/{{ $article->uploadone}}" class="gx-btn gx-btn-sm gx-btn-primary">Download with Author name</a>
                                    <!-- <a href="/uploads/{{ $article->uploadtwo}}" class="gx-btn gx-btn-sm gx-flat-btn gx-btn-primary">Download Without Author Name</a> -->
                                </div>
                            </div>
                        </div>
