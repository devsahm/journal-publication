            ...
            <div class="gx-wrapper">
                <div class="animated slideInUpTiny animation-duration-3">
                    <div class="page-heading d-sm-flex justify-content-sm-between align-items-sm-center">
                        <h2 class="title mb-3 mb-sm-0">membership Licensing Application</h2>
                        <nav class="mb-0 breadcrumb">
                            <a href="/admin" class="breadcrumb-item">Dashboard</a>
                            
                            <span class="active breadcrumb-item">Membership Application</span>
                        </nav>
                    </div>
                                        ...
                                        <table class="table table-users default-table table-hover">
                                            ...
                                            <tr>
                                              ...
                                              <td><?php echo $counter; ?></td>
                                                ...
                                                <td>
                                                  <div>
                                                    <a href="/membership/admin/membership-registration/view/{{ $info->id }}" class="btn btn-info" style="margin-left: 20px" ><i class="fa fa-eye"></i>View Details</a>
                                                </div>
                                                </td>
                                              
                                                <td><a href="/membership/member-send-email/{{ $info->id }}" class="btn btn-primary">Compose Mail</a></td>
