            ...
            <div class="gx-wrapper">
                ...
                <div class="animated slideInUpTiny animation-duration-3">
                    ...
                    <div class="page-heading d-sm-flex justify-content-sm-between align-items-sm-center">
                        <h2 class="title mb-3 mb-sm-0">Uploaded Images</h2>
                        <nav class="breadcrumb">
                   
                            <a href="/state" class="breadcrumb-item">Dashboard</a>
                            <span class="active breadcrumb-item">Uploaded images</span>
                        </nav>
                    </div>
                    ...
                    <div class="row mb-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="shadow border-0 card">
                                <img class="card-img-top" src="/stategallery/{{$gallery->image}}" alt="Card image cap">
                                <div class="card-body">
                                    <p class="card-text">{{$gallery->caption}}</p>
                                    <form action="/state/stagallery/{{$gallery->id}}" method="post">
                                        @csrf
                                        @method('DELETE')
