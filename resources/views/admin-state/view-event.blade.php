            ...
            <div class="gx-wrapper">
                <div class="animated slideInUpTiny animation-duration-3">
                    <div class="page-heading d-sm-flex justify-content-sm-between align-items-sm-center">
                        <h2 class="title mb-3 mb-sm-0">{{ Auth::guard('state')->user()->state }} State Event/Conference Lists</h2>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-users default-table table-hover">
                                            ...
                                            <td>{{ date('d M Y', strtotime($event->created_at)) }}</td>
                                                <td>
                                                  <div>
                                                    <a href="/state/staevent/{{ $event->id }}" class="btn btn-info" ><i class="fa fa-eye"></i>View</a>
                                                </div>
                                                </td>
                                
                                                <td><a href="/state/staevent/{{ $event->id }}/edit" class="btn btn-primary">Edit</a></td>

                                        
                                                <td class="text-center">
                                                <form method="post" action="/state/staevent/{{ $event->id }}">
                                                 @method('DELETE')
                                                 @csrf
