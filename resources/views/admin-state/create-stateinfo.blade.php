        ...
        <div class="gx-main-content">
            ...
            <div class="gx-wrapper">
                <div class="page-heading d-sm-flex justify-content-sm-between align-items-sm-center">
                    <h2 class="title mb-3 mb-sm-0">STATE INFORMATION</h2>
                    <nav class="mb-0 breadcrumb">
                        <a href="/state" class="breadcrumb-item">Dashboard</a>
                        <span class="active breadcrumb-item">State Information </span>
                    </nav>
                </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="gx-card">
                            ...
                            <div class="gx-card-body">
                               <form class="form" method="post" action="/state/stateinfo" enctype="multipart/form-data">
                                @csrf
                                @include('errors')
                                @include('success')      
                                @include('customerror')
                        ...
                        <div class="gx-card">
                            ...
                            <div class="gx-card-body">
                               ...
                               <form class="form" method="post" action="/state/stateinfo/{{$stateinfo->id}}">
                                @csrf
                                @method('PATCH')
                                @include('errors')
                                @include('success')      
                                @include('customerror')
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-2 col-sm-3 control-label">Address<span style="color:red">*</span></label>
                                        <div class="col-md-10 col-sm-9">
                                            <input class="form-control" placeholder="Location" type="text" name="location" value="{{ $stateinfo->location }}" required>
                                     ...
                                     <div class="form-group row">
                                        <label class="col-md-2 col-sm-3 control-label">Phone Number<span style="color:red">*</span></label>
                                        <div class="col-md-10 col-sm-9">
                                            <input class="form-control" placeholder="Phone Number" type="text" name="phone_number" value="{{$stateinfo->phone_number}}" required>
                                     ...
                                     <div class="form-group row">
                                        <label class="col-md-2 col-sm-3 control-label">Email<span style="color:red">*</span></label>
                                        <div class="col-md-10 col-sm-9">
                                            <input class="form-control" placeholder="Email" type="email" name="email" value="{{$stateinfo->email}}" required>
