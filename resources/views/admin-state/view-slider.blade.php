            ...
            <div class="gx-wrapper">
                ...
                <div class="animated slideInUpTiny animation-duration-3">
                    ...
                    <div class="page-heading d-sm-flex justify-content-sm-between align-items-sm-center">
                        <h2 class="title mb-3 mb-sm-0">SLIDER IMAGES</h2>
                        <nav class="breadcrumb">
                   
                            <a href="/state" class="breadcrumb-item">Dashboard</a>
                            <span class="active breadcrumb-item">Uploaded Slider Images</span>
                        </nav>
                    </div>

                <!--     <div class="gx-entry-header"><h3 class="entry-heading">Basic Cards</h3></div> -->
                    @include('success')
                    <div class="row mb-md-4">
                        ...
                        <div class="col-md-6">
                            <div class="shadow border-0 card">
                                <img class="card-img-top" src="/stategallery/{{$slider->image}}" alt="Card image cap">
                                <div class="card-body">
                                
                                    <form action="/state/staslider/{{$slider->id}}" method="post">
                                        @csrf
                                        @method('DELETE')
                                        <input  class="btn btn-danger" type="submit" value="Delete" onclick="return confirm('Are you sure you want to delete this image?');">
                                    </form>
                        ...
                        @endforeach
                        @else
                        <p class="alert alert-warning">No slider image record was found</p>
