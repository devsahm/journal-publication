        ...
        <div class="gx-main-content">
            ...
            <div class="gx-wrapper">
                <div class="page-heading d-sm-flex justify-content-sm-between align-items-sm-center">
                    <h2 class="title mb-3 mb-sm-0">EVENT/CONFERENCE</h2>
                    ...
                    <div class="col-lg-12">
                        <div class="gx-card">
                            <div class="gx-card-header">
                                <h3 class="card-title">Add New Event/Conference Record</h3>
                            </div>
                            <div class="gx-card-body">
                               <form class="form" method="post" action="/state/staevent/{{$staevent->id}}" enctype="multipart/form-data">
                                @csrf
                                @method('PATCH')
                                @include('errors')
                                @include('success')      
                                @include('customerror')
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 col-sm-9">
                                            <input class="form-control" placeholder="Event Title" type="text" name="title" value="{{$staevent->title}}" required>
                                     ...
                                     <div class="form-group row">
                                        ...
                                        <div class="col-md-10 col-sm-9">
                                            <input class="form-control" placeholder="Event Date" type="text" name="date" value="{{$staevent->date}}" required>
                                     ...
                                     <div class="form-group row">
                                        ...
                                        <div class="col-md-10 col-sm-9">
                                            <input class="form-control" placeholder="Location" type="text" name="location" value="{{$staevent->location}}" required>
                                    ...
                                    <div class="line-dashed"></div>
                                     <div class="form-group row">
                                        ...
                                        <div class="col-md-10 col-sm-9">
                                        <textarea id="summernote" name="event_details">{{ $staevent->event_details }}</textarea>  
